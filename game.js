...
// Variable to store selected font
let selectedFont = 'Impact'; // Default font
...
const words = [
  ...
  ['BOOK', 'FOUR', 'NINE', 'FIVE', 'TOOK', 'HOOK', 'AELA', 'CAKE', 'TAKE', 'MAKE', 'DUST', 'RUST', 'FUSS', 'FROG', 'CATS', 'DOGS', 'DAWN', 'FAWN', 'LAWN', 'YAWN', 'RIPE', 'ROLL', 'RICE', 'ROOM', 'BOOM', 'LOOM', 'PORT', 'FORT', 'LOGS', 'DIGS', 'SUNS', 'SONS', 'HATS', 'PLUS', 'BATS', 'BUGS', 'GIFT', 'HOPE', 'JUMP', 'KITE', 'LAMP', 'MOON', 'BEES', 'TREE', 'FISH', 'STAR', 'RATS', 'JILL', 'PHIL', 'TIME', 'NORA', 'ELLA', 'POND', 'RING', 'TOYS', 'SNOW', 'PINK', 'BIKE', 'DUCK', 'SHIP', 'LACE', 'FACE', 'RACE', 'PACE', 'BIRD', 'WIND', 'WAVE', 'RIDE'],
  ...
  ['BASKETS', 'CUPCAKES', 'BALANCE', 'PENGUIN', 'BROTHER', 'BOTTLES', 'BUTTERS', 'CHOCOLATE', 'CUCUMBER', 'DIAMOND', 'GIRAFFE', 'MEADOWS', 'PUZZLES', 'POPCORN', 'STATION', 'RAINBOW', 'SAUSAGE', 'SWEATER', 'TURTLES', 'GIRAFFE', 'PICTURE', 'NOTEBOOK', 'ABOLISH', 'ABIGAIL', 'ACQUIRE', 'BUNDLES', 'BUNGLED', 'BURGERS',  'ELEPHANT', 'STRAWBERRY', 'AVOCADO', 'VILLAGE', 'PYJAMAS', 'BALLOON', 'ROCKING']
];

// Hard mode word list
const hardModeWords = [
'Cat Box', 'Go Up', 'Hi Mom', 'By Now', 'Do It', 'Yes Sir', 'Yes Mam', 'No Mam', 'Be Cool', 'Go Fast', 'Hi Dad', 'No Way', 'So Fun', 'Be Good', 'Hi Pal', 'Go Far', 'Hi Bud', 'No Sir', 'So Bad', 'Be Safe', 'Hi Guy', 'Go Now', 'Hi Sis', 'No Thanks', 'On Top', 'Big Hat', 'My Car', 'My Dog', 'A Book', 'Act', 'Pop Tart', 'On Top', 'Bop It', 'Robotic', 'Bedtime', 'Circular', 'Rectangular', 'Dog Bowl', 'My Mom', 'Christmas Eve', 'My Dad', 'Dig Dug', 'Pattie Cake', 'Run Away', 'Sunscreen', 'Funny Hat', 'Battlebots', 'Big Cat', 'Bug', 'Mug', 'Ben', 'Cup', 'Cut', 'A Toy', 'Box', 'Fan', 'Pot', 'Red', 'Hop on Top', 'Pin', 'Web', 'Wet', 'Jet', 'Pig', 'Log', 'Rat', 'Ant', 'Map', 'Car', 'Book', 'Took', 'Hook', 'Aela', 'Cake', 'Take', 'Make', 'Dust', 'Rust', 'Fuss', 'Frog', 'Cats', 'Dogs', 'Logs', 'Digs', 'Suns', 'Sons', 'Hats', 'Bats', 'Bugs', 'Gift', 'Hope', 'Jump', 'A Kite', 'Lamp', 'Moon', 'Bees', 'Tree', 'Fish', 'Star', 'Rats', 'Jill', 'Phil', 'Nora', 'Ella', 'Pond', 'Ring', 'Toys', 'Snow', 'Pink', 'Bike', 'Duck', 'Ship', 'Bird', 'Windy Day', 'Wave', 'Ride', 'Apple', 'Mommy', 'Daddy', 'Brown', 'Clock', 'Dream', 'Eagle', 'Fruit', 'Green', 'Happy', 'Image', 'Jelly', 'River', 'Mouse', 'Rosebushes', 'Quick Fox', 'Lazy Dog', 'Jumped Over', 'Bird Feather',  'Honey', 'Brush', 'Sheep', 'House', 'Night', 'Plane', 'Brick', 'Sweet', 'Grass', 'A Smile', 'A Light', 'Crisp', 'Fairy', 'Price', 'Water', 'Cloud', 'Peach', 'Evelyn', 'Banana', 'Button', 'Sister', 'Mother', 'Father', 'Camera', 'Danger', 'Flower', 'Garden', 'Hungry', 'Jacket', 'Kitten', 'Laptop', 'Pencil', 'Rocket', 'Marker', 'Cookie', 'Dinner', 'Family', 'Window', 'Pillow', 'Jungle', 'Tigers', 'Bottle', 'Hammer', 'Tunnel', 'Jigsaw', 'Zipper', 'Oceans', 'Candle', 'Castle', 'Cattle', 'Sunset', 'Baskets', 'Cupcakes', 'Balance', 'Penguin', 'Brother', 'Bottles', 'Butters', 'Chocolate', 'Cucumber', 'Diamond', 'Giraffe', 'Meadows', 'Puzzles', 'Popcorn', 'Station', 'Rainbow', 'Sausage', 'Sweater', 'Turtles', 'Giraffe', 'Picture', 'Notebook', 'Elephants', 'Strawberries', 'Avocado', 'Villages', 'Pyjamas', 'Balloons', 'Rocking', 'Turn On', 'Turn Off', 'Go Fast', 'Go Slow', 'Look Up', 'Look Down', 'Look Left', 'Look Right', 'Move Up', 'Move Down', 'Move Left', 'Move Right', 'Jump Up', 'Jump Down', 'Jump Left', 'Jump Right'
];
...
class Asteroid {
  ...
  draw() {
    ...
    ctx.lineWidth = 1.5;
    ctx.font = `28px ${selectedFont}`; // Use the selected font
    ...
    // Increase letter spacing for OpenDyslexic font in Normal Mode
    let letterSpacing = selectedFont === 'OpenDyslexic' && !hardMode ? 25 : 20;

    for (let i = 0; i < this.word.length; i++) {
      const char = this.word[i];
      const isHighlighted = i <= this.lastHighlightedIndex;
      ctx.fillStyle = isHighlighted ? 'green' : 'red';
      ctx.fillText(char, xOffset + i * letterSpacing, yOffset);
      ctx.strokeText(char, xOffset + i * letterSpacing, yOffset);
    }
  }
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const fontOptions = document.querySelectorAll('#fontSelect .fontOption');
